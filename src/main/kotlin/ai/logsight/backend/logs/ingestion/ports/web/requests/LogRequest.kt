...
data class LogRequest(
    ...
    val message: String,
    @get:Pattern(regexp = "INFO|WARNING|WARN|FINE|FINER|DEBUG|ERR|ERROR|EXCEPTION|SEVERE", message = "level must be one of INFO|WARNING|WARN|FINE|FINER|DEBUG|ERR|ERROR|EXCEPTION|SEVERE")
    val level: String?,
    val metadata: String?,
)
