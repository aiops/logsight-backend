...
import ai.logsight.backend.compare.limit.CompareLimitService
...
class CompareController(
    ...
    val compareLimitService: CompareLimitService
) {
    ...
    fun createCompare(
        ...
        @Valid @RequestBody
        getCompareResultRequest: GetCompareResultRequest
    ): CompareDataResponse {
        ...
        compareLimitService.checkTagLimit(user, compareDTO.baselineTags, compareDTO.candidateTags)
    ...
    fun updateCompareStatusByID(
        authentication: Authentication,
        @Valid @RequestBody
        updateCompareStatusRequest: UpdateCompareStatusRequest
    ): UpdateCompareStatusResponse {
        val user = userStorageService.findUserByEmail(authentication.name)
        return UpdateCompareStatusResponse(
            compareService.updateCompareStatusByID(
                updateCompareStatusRequest.compareId,
                updateCompareStatusRequest.compareStatus,
                user
            )
        )
    }
