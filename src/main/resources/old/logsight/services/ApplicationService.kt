...
//        }
//        val application =
//            Application(id = 0, name = name, user = user, status = ApplicationStatus.IN_PROGRESS, inputTopicName = "")
...
//                        "http://$kibanaUrl/kibana/s/kibana_space_${application.user.key}/api/saved_objects/index-pattern/$indexPattern",
//                        HttpMethod.DELETE,
//                        request
//                    )
//                } catch (e: Exception) {
